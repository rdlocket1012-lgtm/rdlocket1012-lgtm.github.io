...
export type PushType = 'letter' | 'coupon_gift' | 'coupon_redeem_request' | 'coupon_redeemed' | 'coupon_declined' | 'coupon_streak_restore' | 'milestone' | 'quiz' | 'partner_joined' | 'nudge_hug' | 'nudge_kiss_request' | 'letter_reaction' | 'bite' | 'thumb_kiss' | 'live_invite' | 'draw_invite' | 'partner_draw';
