      ...
      <View style={{ backgroundColor: LK.parchment, borderTopLeftRadius: 30, borderTopRightRadius: 30, maxHeight: '88%' }}>
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ padding: 22, paddingBottom: 40 }}>
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center', gap: 6, marginTop: 8 }}>
            <ScalePressable onPress={() => Linking.openURL(LINKS.termsOfService)} haptic={false} accessibilityRole="link" accessibilityLabel="Terms of Service" hitSlop={{ top: 14, bottom: 14, left: 6, right: 6 }}>
            ...
            <ScalePressable onPress={() => Linking.openURL(LINKS.privacyPolicy)} haptic={false} accessibilityRole="link" accessibilityLabel="Privacy Policy" hitSlop={{ top: 14, bottom: 14, left: 6, right: 6 }}>
