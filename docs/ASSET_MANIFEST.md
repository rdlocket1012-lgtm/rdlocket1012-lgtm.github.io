...
| `mascot/drawing.png` | ✅ 2026-07-12 | **NEW** (§9.6b Creative tile "Draw"): Lo holding a marigold crayon, gen `179b1b0e` + bg `952dba1b` (nano_banana_flash, canonical ref). 1024px, alpha verified. Known nit: faint lettering on the crayon wrapper — invisible at the 56–72px render, regenerate if it ever matters. |
| `mascot/guessing.png` | ✅ 2026-07-12 | **NEW** (§9.6b Creative tile "Draw & Guess"): Lo holds a sketch pad, Kit puzzles under a question-mark doodle, gen `acfd09af` + bg `14a0eea5`. 1024px, alpha verified. |
